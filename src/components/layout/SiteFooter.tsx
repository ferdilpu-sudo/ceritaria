...
export function SiteFooter() {
  return (
    <footer className="mt-12 border-t border-[var(--border)] pb-6 pt-7 sm:mt-20 sm:py-10">
      <div className="shell flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav aria-label="Footer" className="flex flex-wrap justify-center gap-x-5 gap-y-3 text-xs muted sm:justify-start sm:text-sm">
