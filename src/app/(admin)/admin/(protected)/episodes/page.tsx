            ...
            return (
              <article key={item.id} className="surface min-w-0 rounded-2xl p-4 sm:flex sm:items-center sm:gap-4 sm:p-5">
                <div className="flex min-w-0 items-start gap-3 sm:flex-1 sm:items-center sm:gap-4">
                  <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl border border-[var(--border)] bg-[var(--surface-2)] text-[10px] font-black text-[var(--muted)] sm:h-14 sm:w-14 sm:text-xs">
                ...
                <div className="mt-4 grid min-w-0 grid-cols-2 gap-2 sm:mt-0 sm:flex sm:shrink-0">
                  <Link href={`/admin/episodes/${item.id}/edit`} className="min-h-11 min-w-0 rounded-xl border border-[var(--border)] bg-white px-3 py-3 text-center text-sm font-bold text-[var(--text)] hover:bg-[var(--surface-2)] sm:px-4">
                    Edit
                  </Link>
